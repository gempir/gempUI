...
gWorldmarkers:SetBackdropColor(G.color.r, G.color.g, G.color.b, G.color.a)
gWorldmarkers:SetBackdropBorderColor(G.bordercolor.r, G.bordercolor.g, G.bordercolor.b, G.bordercolor.a)
...
gAutomatorConfig:SetBackdropColor(G.color.r, G.color.g, G.color.b, G.color.a)
gAutomatorConfig:SetBackdropBorderColor(G.bordercolor.r, G.bordercolor.g, G.bordercolor.b, G.bordercolor.a)
...
gDamage:SetBackdropColor(G.color.r, G.color.g, G.color.b, G.color.a)
...
gAC_1:SetBackdropBorderColor(G.bordercolor.r, G.bordercolor.g, G.bordercolor.b, G.bordercolor.a)
gAC_1:EnableMouse()
...
gAC_2:SetBackdropBorderColor(G.bordercolor.r, G.bordercolor.g, G.bordercolor.b, G.bordercolor.a)
gAC_2:EnableMouse()
...
gAC_3:SetBackdropBorderColor(G.bordercolor.r, G.bordercolor.g, G.bordercolor.b, G.bordercolor.a)
gAC_3:EnableMouse()
...
gAC_5:SetBackdropColor(0, 0, 0, 0)
gAC_5:SetBackdropBorderColor(G.bordercolor.r, G.bordercolor.g, G.bordercolor.b, G.bordercolor.a)
gAC_5:EnableMouse()
